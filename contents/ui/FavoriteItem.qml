  ...
  Rectangle {
    ...
    states: [
      State {
        ...
        PropertyChanges {
          target: rect;color: plasmoid.configuration.theming == 0 ? "#292A2E" : plasmoid.configuration.theming == 1 ? "#FFFFFF" : PlasmaCore.Theme.buttonHoverColor
        }
      },
      State {
        name: "default";when: (!highlighted)
        PropertyChanges {
          target: rect;color: plasmoid.configuration.theming == 0 ? "#202124" : plasmoid.configuration.theming == 1 ? "#F7F7F7" : PlasmaCore.Theme.buttonBackgroundColor
        }
      }
    ]
